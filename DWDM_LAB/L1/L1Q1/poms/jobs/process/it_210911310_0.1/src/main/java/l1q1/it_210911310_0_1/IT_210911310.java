...
/**
 * Job: IT_210911310 Purpose: using ETL tool<br>
 * Description: <br>
 * 
 ...
 * @status DEV
 */
public class IT_210911310 implements TalendJob {
	...
	private final String jobName = "IT_210911310";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(IT_210911310.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_L1Q1_IT_210911310 = new byte[0];
		static byte[] commonByteArray_L1Q1_IT_210911310 = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_L1Q1_IT_210911310) {
...
///////////////////////    			
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "D:/210911310/sample1.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"D:/210911310/sample1.csv", "ISO-8859-15", ",", "\n", true, 0, 0,
...
///////////////////////    			
					...
					if (!((Object) ("D:/210911310/sample1.csv") instanceof java.io.InputStream)) {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_L1Q1_IT_210911310.length) {
					if (length < 1024 && commonByteArray_L1Q1_IT_210911310.length == 0) {
						commonByteArray_L1Q1_IT_210911310 = new byte[1024];
					} else {
						commonByteArray_L1Q1_IT_210911310 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_L1Q1_IT_210911310, 0, length);
				strReturn = new String(commonByteArray_L1Q1_IT_210911310, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_L1Q1_IT_210911310, 0, length);
				strReturn = new String(commonByteArray_L1Q1_IT_210911310, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
///////////////////////    			
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */
						"D:/210911310/sample1.csv"/** End field tFileInputDelimited_2:FILENAME */
				;
...
///////////////////////		
							...
							if (row2.customerid != null) { //
								...
								strBuffer_tLogRow_2.append(String.valueOf(row2.customerid));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final IT_210911310 IT_210911310Class = new IT_210911310();

		int exitCode = IT_210911310Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = IT_210911310.class.getClassLoader()
					.getResourceAsStream("l1q1/it_210911310_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = IT_210911310.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : IT_210911310");
		}
...
/************************************************************************************************
 * 58136 characters generated by Talend Open Studio for Data Integration on the
 * 13 January 2024 at 10:01:19 AM IST
 ************************************************************************************************/