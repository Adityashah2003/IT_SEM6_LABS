...
package l1q1.it_210911310_7_0_1;
 ...
 * @status
 */
public class IT_210911310_7 implements TalendJob {
	...
	private final String jobName = "IT_210911310_7";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					IT_210911310_7.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(IT_210911310_7.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_L1Q1_IT_210911310_7 = new byte[0];
		static byte[] commonByteArray_L1Q1_IT_210911310_7 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_L1Q1_IT_210911310_7.length) {
					if (length < 1024 && commonByteArray_L1Q1_IT_210911310_7.length == 0) {
						commonByteArray_L1Q1_IT_210911310_7 = new byte[1024];
					} else {
						commonByteArray_L1Q1_IT_210911310_7 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_L1Q1_IT_210911310_7, 0, length);
				strReturn = new String(commonByteArray_L1Q1_IT_210911310_7, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_L1Q1_IT_210911310_7, 0, length);
				strReturn = new String(commonByteArray_L1Q1_IT_210911310_7, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_L1Q1_IT_210911310_7) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class Comparablerow1Struct extends row1Struct implements Comparable<Comparablerow1Struct> {
					...
					public int compareTo(Comparablerow1Struct other) {
						...
						if (this.marks == null && other.marks != null) {
							return -1;

						} else if (this.marks != null && other.marks == null) {
							return 1;
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					for (row1Struct tmpRow_tFixedFlowInput_1 : cacheList_tFixedFlowInput_1) {
						...
						arrayRowtSortRow_1_SortOut.student = row1.student;
						arrayRowtSortRow_1_SortOut.subject = row1.subject;
						arrayRowtSortRow_1_SortOut.marks = row1.marks;
				...
				util_tLogRow_1.addRow(new String[] { "student", "subject", "marks", });
...
///////////////////////    			
				...
				for (int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++) {
					...
					row2.student = current_tSortRow_1_SortIn.student;
					row2.subject = current_tSortRow_1_SortIn.subject;
					row2.marks = current_tSortRow_1_SortIn.marks;
...
///////////////////////		
					...
					if (row2.student != null) { //
						row_tLogRow_1[0] = String.valueOf(row2.student);

					} //

					if (row2.subject != null) { //
						row_tLogRow_1[1] = String.valueOf(row2.subject);

					} //

					if (row2.marks != null) { //
						row_tLogRow_1[2] = String.valueOf(row2.marks);
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final IT_210911310_7 IT_210911310_7Class = new IT_210911310_7();

		int exitCode = IT_210911310_7Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = IT_210911310_7.class.getClassLoader()
					.getResourceAsStream("l1q1/it_210911310_7_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = IT_210911310_7.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : IT_210911310_7");
		}
...
/************************************************************************************************
 * 66248 characters generated by Talend Open Studio for Data Integration on the
 * 13 January 2024 at 11:05:07 AM IST
 ************************************************************************************************/