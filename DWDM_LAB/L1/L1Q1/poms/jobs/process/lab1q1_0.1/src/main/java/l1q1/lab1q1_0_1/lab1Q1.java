...
/**
 * Job: lab1Q1 Purpose: using ETL tool<br>
 * Description: <br>
 * 
 ...
 * @status DEV
 */
public class lab1Q1 implements TalendJob {
	...
	private final String jobName = "lab1Q1";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(lab1Q1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_L1Q1_lab1Q1 = new byte[0];
		static byte[] commonByteArray_L1Q1_lab1Q1 = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_L1Q1_lab1Q1) {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_L1Q1_lab1Q1.length) {
					if (length < 1024 && commonByteArray_L1Q1_lab1Q1.length == 0) {
						commonByteArray_L1Q1_lab1Q1 = new byte[1024];
					} else {
						commonByteArray_L1Q1_lab1Q1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_L1Q1_lab1Q1, 0, length);
				strReturn = new String(commonByteArray_L1Q1_lab1Q1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_L1Q1_lab1Q1, 0, length);
				strReturn = new String(commonByteArray_L1Q1_lab1Q1, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final lab1Q1 lab1Q1Class = new lab1Q1();

		int exitCode = lab1Q1Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = lab1Q1.class.getClassLoader()
					.getResourceAsStream("l1q1/lab1q1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = lab1Q1.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : lab1Q1");
		}
...
/************************************************************************************************
 * 57932 characters generated by Talend Open Studio for Data Integration on the
 * 13 January 2024 at 9:56:08 AM IST
 ************************************************************************************************/